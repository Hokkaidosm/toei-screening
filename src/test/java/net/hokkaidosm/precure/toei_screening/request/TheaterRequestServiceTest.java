...
@SpringBootTest
public class TheaterRequestServiceTest {
	DateTimeFormatter formatter = DateTimeFormatter.ISO_ZONED_DATE_TIME;
	@Autowired
	private TheaterRequestService service;
	...
	public void test_getUri() {
		...
		String expected = "https://toei-bookingsystem-api-prod.azurewebsites.net/api/hp/theaters/screening/02846";
	...
	public void test_getTitle() {
		...
		List<Theater> actual = null;
		try {
			actual = service.getTheaters(titleCd);
